...
class _DreamScreenState extends State<DreamScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Dreams", style: GoogleFonts.lora(fontWeight: FontWeight.bold)),
        centerTitle: true,
        backgroundColor: Colors.transparent,
      ),
      body: _loading
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Text("New Dream", style: GoogleFonts.inter(color: Colors.white, fontWeight: FontWeight.bold)),
        elevation: 0,
      ),
    );
  }
