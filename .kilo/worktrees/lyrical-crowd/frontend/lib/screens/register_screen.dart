        ...
        child: Center(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                Icon(Icons.psychology_outlined, size: 80, color: Theme.of(context).primaryColor),
                const SizedBox(height: 16),
                Text('Create an Account', style: GoogleFonts.inter(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.black87)),
