...
class _DreamScreenState extends State<DreamScreen> {
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            Text("Dream Log", style: GoogleFonts.lora(fontSize: 28, fontWeight: FontWeight.bold)),
            ...
            SizedBox(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Text("Save Dream", style: GoogleFonts.inter(fontSize: 16, color: Colors.white, fontWeight: FontWeight.bold)),
                ),
              ),
            ),
            const SizedBox(height: 24),
  ...
  Widget _buildContent() {
    return Scaffold(
      backgroundColor: Colors.transparent,
      appBar: AppBar(
        title: Text("Dreams", style: GoogleFonts.lora(fontWeight: FontWeight.bold, color: Colors.white)),
        centerTitle: true,
      ...
      body: _loading
          ...
          : entries.isEmpty
              ? Center(child: Text("No dreams recorded yet.", style: GoogleFonts.lora(fontSize: 18, color: Colors.black45)))
              : ListView.builder(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text("New Dream", style: GoogleFonts.inter(color: Colors.white, fontWeight: FontWeight.bold)),
            ],
          ),
        ),
      ),
